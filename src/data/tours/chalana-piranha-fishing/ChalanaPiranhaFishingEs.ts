...
export const chalanaPiranhaFishingEs: Tour = {
  ...
  shortDescription: 'Navegación en barco típico "chalana" por el Río Miranda, con una parada para la tradicional y divertida pesca de pirañas. Ideal para la observación de aves acuáticas.',
  mainImage: img,
  durationInHours: 2.5,
