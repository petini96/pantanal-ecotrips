...
export const estanciaMimosaPt: Tour = {
  ...
  shortDescription: 'Trilha na mata ciliar do rio Mimoso com paradas para banho em cachoeiras, piscinas naturais, plataforma para salto e um passeio de barco a remo.',
  mainImage: img,
  durationInHours: 4,
