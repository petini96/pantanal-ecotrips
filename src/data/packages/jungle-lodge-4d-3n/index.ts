...
import { jungleLodgeAnacondaPtItinerary } from './itinerary-data';
import { jungleLodgeImages } from '../common-data/jungle-lodge';
import { jungleLodgeHotelPt } from "src/data/hotels/jungle-lodge";
import { jungleLodgeAnacondaEnItinerary } from './itinerary-data';
import { jungleLodgeAnacondaEsItinerary } from './itinerary-data';
...
export const jungleLodgeAnacondaPt: TourPackage = {
    ...
    subtitle: "4 dias de imersão completa na diversidade de atividades pantaneiras.",
    description: [
...
export const jungleLodgeAnacondaEn: TourPackage = {
    ...
    subtitle: "4 days of complete immersion in the diversity of Pantanal activities.",
    description: [
...
export const jungleLodgeAnacondaEs: TourPackage = {
    ...
    subtitle: "4 días de inmersión completa en la diversidad de actividades pantaneras.",
    description: [
