...
import { jungleLodgeOtterPtItinerary } from './itinerary-data';
import { jungleLodgeImages } from '../common-data/jungle-lodge';
import { jungleLodgeHotelPt } from "src/data/hotels/jungle-lodge";
import { jungleLodgeOtterEnItinerary } from './itinerary-data';
import { jungleLodgeOtterEsItinerary } from './itinerary-data';
...
export const jungleLodgeOtterEs: TourPackage = {
    ...
    subtitle: "Una escapada rápida de 2 días para sentir la esencia del Pantanal.",
    description: [
