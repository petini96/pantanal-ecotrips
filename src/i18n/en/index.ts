export default {
  ...
  meta_keywords: 'pantanal jungle lodge, jungle lodge, pantanal ms, pantanal, bonito ms, bonito, ecotourism, tours, travel, pantanal ecotrips, pantanal tourism, pantanal trip, pantanal lodge, jaguar safari, campo grande ms, mato grosso do sul',
  ...
  north_pantanal: "Northern Pantanal",
  south_pantanal: "Southern Pantanal",
  amazon: "Amazon",
  bolivia: "Bolivia",
  ...
  hotels_title: "Accommodations",
  hotels_subtitle: "Where to stay in this region",
  ...
  no_attractions_found: "No attractions found for this category.",
  guide_highlight_eyebrow: "Your Guide in the Wild",
  guide_highlight_title: "In Bonito, English-speaking guides are rare",
  guide_highlight_subtitle: "Most guides in Bonito don't speak fluent English. With Ronaldo, communication is always clear — whether it's explaining wildlife, the itinerary, or handling any unexpected situation. A difference you feel at every step.",
  guide_name: "Ronaldo Mendoza Ribeiro",
  guide_role: "Founder & Certified Guide · Since 2000",
  guide_years_label: "years of\nexperience",
  guide_diff_1: "Clear communication in English, Spanish & German",
  guide_diff_2: "In-field interpretation of local fauna and flora",
  guide_diff_3: "100% personalized itineraries for your profile",
  explore_destinations_title: "What To Do in Each Destination",
  explore_destinations_subtitle: "Each region holds unique experiences. Explore exclusive attractions in Bonito, the Pantanal, and beyond.",
  see_attractions_btn: "See Attractions",
};