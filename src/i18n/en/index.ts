export default {
  ...
  meta_title: 'Pantanal Ecotrips | Travel Packages to Pantanal and Bonito',
  meta_description: 'Specialists in ecotourism in the Pantanal and Bonito. We offer travel packages, tours, and unique experiences with nature in Mato Grosso do Sul.',
  meta_keywords: 'pantanal, bonito, ecotourism, travel packages, pantanal ecotrips, pantanal tourism, bonito tours, pantanal trip, campo grande ms, mato grosso do sul',
